...
if split_method == 1:
    ...
    dataset_test = np.array(df[int(df.shape[0]*0.7)-days_grouped:int(df.shape[0]*0.9)])
...
dataset_proj = np.array(df[int(df.shape[0]*0.9)-days_grouped:int(df.shape[0]*0.9)])
data_proj_raw = df[int(df.shape[0]*0.9):int(df.shape[0]*0.9)+30]
